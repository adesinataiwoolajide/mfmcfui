                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__header">
                            ...
                            <div class="dt-card__heading">
                                <h3 class="dt-card__title">Unit Registration Form</h3>
                            </div>
                            <!-- /card heading -->
                                ...
                                <div class="form-row">
                                    <div class="col-sm-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationDefault01"
                                            placeholder="Enter Unit Name" required name="unit_name">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        <button class="btn btn-primary btn-lg btn-block text-uppercase" type="submit">Add The Unit</button>
                                    </div>
                                </div>
