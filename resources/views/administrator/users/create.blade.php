                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__header">
                            ...
                            <div class="dt-card__heading">
                                <h3 class="dt-card__title">User Registration Form</h3>
                            </div>
                            <!-- /card heading -->
                        ...
                        <div class="dt-card__body">
                            ...
                            <form action="{{route('user.save')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationDefault01"
                                            placeholder="Enter Full Name" required name="name">
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="password" class="form-control" id="validationDefault04"
                                            placeholder="Repeat Your Password" required name="confirm_password">
                                ...
                                <button class="btn btn-primary btn-lg btn-block text-uppercase" type="submit">Add The User</button>
                            </form>
                            <!-- /form -->
