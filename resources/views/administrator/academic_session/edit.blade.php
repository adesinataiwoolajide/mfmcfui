                ...
                <div class="col-12">
                            ...
                            <div class="dt-card">
                                ...
                                <ol class="mb-0 breadcrumb">
                                    ...
                                    @if (auth()->user()->hasPermissionTo('Edit Session') OR 
                                        ...
                                        <li class="breadcrumb-item"><a href="{{route('session.edit', $sess->session_id)}}">
                                            Edit Session</a></li>
                                    @endif
                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__body">
                            ...
                            <form action="{{route('session.update', $sess->session_id)}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-row">
                                    <div class="col-sm-8 mb-3">
                                        
                                        <input type="text" class="form-control" id="validationDefault01"
                                            placeholder="Enter Session Name" value="{{$sess->session_name}}" required name="session_name">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        <button class="btn btn-primary btn-lg btn-block text-uppercase" type="submit">Update The Session</button>
                                    </div>
                                </div>
