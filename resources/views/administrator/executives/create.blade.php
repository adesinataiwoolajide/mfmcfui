                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__header">
                            ...
                            <div class="dt-card__heading">
                                <h3 class="dt-card__title">Excos Registration Form</h3>
                            </div>
                            <!-- /card heading -->
                        ...
                        <div class="dt-card__body">
                            ...
                            <form action="{{route('excos.save')}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-row">
                                    <div class="col-sm-3 mb-3">
                                        <label for="validationDefault01">Passport</label>
                                    ...
                                    <div class="col-sm-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationDefault01"
                                            placeholder="Enter Other Names" required name="other_names">
                                    ...
                                    <div class="col-sm-3 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="validationDefault01"
                                            placeholder="Enter Phone Number" required name="phone_number">
                                    ...
                                    <div class="col-sm-3 mb-3">
                                        ...
                                        <div class="input-group date" id="date-time-picker-1"
                                            ...
                                            <input type="text" class="form-control datetimepicker-input"
                                                   data-target="#date-time-picker-1"/ name="dob" required>
                                ...
                                <button class="btn btn-primary btn-lg btn-block text-uppercase" type="submit">Add The Executive</button>
                            </form>
                            <!-- /form -->
