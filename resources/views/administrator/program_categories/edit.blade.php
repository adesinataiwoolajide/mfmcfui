                            ...
                            <div class="dt-card">
                                ...
                                <ol class="mb-0 breadcrumb">
                                    ...
                                    @if (auth()->user()->hasPermissionTo('Edit Program Category') OR 
                                        ...
                                        <li class="breadcrumb-item"><a href="{{route('program.category.edit', $cate->program_category_id)}}">Edit Program Category</a></li>
                                    @endif
                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__header">
                            ...
                            <div class="dt-card__heading">
                                <h3 class="dt-card__title">Program Category Update Form</h3>
                            </div>
                            <!-- /card heading -->
                        ...
                        <div class="dt-card__body">
                            ...
                            <form action="{{route('program.category.update', $cate->program_category_id)}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-row">
                                    <div class="col-sm-8 mb-3">
                                        
                                        <input type="text" class="form-control" id="validationDefault01"
                                        placeholder="Enter Program Category Name" required name="program_category_name" value="{{$cate->program_category_name}}">
                                    ...
                                    <input type="hidden" name="program_category-id" value="{{$cate->program_category_id}}">
                                    <div class="col-sm-4 mb-3">
                                        <button class="btn btn-primary btn-lg btn-block text-uppercase" type="submit">Update The Program Category</button>
                                    </div>
                                </div>
